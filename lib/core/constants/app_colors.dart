...
abstract class AppColors {
  ...
  static const Color primaryLight     = Color(0xFFC73E22); // brand-deep (hover shade)
  static const Color primaryContainer = Color(0x17E64B2E); // brand-tint: rgba(230,75,46,0.09)

  // Accent — same as primary so there is only ONE brand orange
  static const Color accent      = Color(0xFFE64B2E);
  ...
  // Gradient stops — brand orange → brand-deep
  static const Color gradientStart  = Color(0xFFE64B2E);
  static const Color gradientEnd    = Color(0xFFC73E22);
  static const Color gradientAccent = Color(0xFFE64B2E);
}
